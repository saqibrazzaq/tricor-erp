<%@ Page Title="" Language="C#" MasterPageFile="~/Tricor.Master" AutoEventWireup="true" CodeBehind="ViewApprovedOrders.aspx.cs" Inherits="TricorERP.SCM.ViewApprovedOrders" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="h2">Approved Orders</h2>
        ...
        <asp:ListView ID="ApprovedOrderListview" runat="server" OnItemCommand="ApprovedOrderListview_ItemCommand" OnSelectedIndexChanged="ApprovedOrderListview_SelectedIndexChanged">
            ...
            <ItemTemplate>
                <tr id="Tr1" runat="server">
                    ...
                    <td>
                        <asp:LinkButton runat="server" CommandName="none" CommandArgument='<%# Eval("ID") %>' Text='<%# Eval("CustomerID") %>'></asp:LinkButton>
                    </td>
                    <td>
