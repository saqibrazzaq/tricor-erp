<%@ Page Title="" Language="C#" MasterPageFile="~/Tricor.Master" AutoEventWireup="true" CodeBehind="AddNewPurchaseOrder.aspx.cs" Inherits="TricorERP.SCM.PurchaseOrder" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="AddNewPurchaseOrder.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel-heading">
            ...
            <div class="container-fluid">
                ...
                <div class="panel-body">
                    <asp:ListView ID="ProductListviewconfirmed" runat="server" OnItemCommand="ProductListview_ItemCommand">
                        <LayoutTemplate>
                            <table class="table table-bordered table-hover" runat="server" id="productTable">
                                <tr class="active">
                                    <th>ID</th>
                        ...
                        <ItemTemplate>
                            <tr id="Tr1" runat="server">
                                ...
                                <td class="ItemCol_RecivedQuantity">
                                    <%# Eval("RecivedQuantity") %>
                                </td>
                                <td>
                                    <button type="button" class="ItemRowEdit2 btn btn-default btn-xs" data-toggle="modal" data-target="#PurchaseOrderItemEditModal">
                                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                    </button>
                                </td>
                                <td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      { %>
                        <div class="row form-group">
                            <div class="col-lg-2">
                                <label class="">Recived Quantity</label>
                            </div>

                            <div class="col-lg-3">
                                <asp:TextBox CssClass="form-control txtRecivedQuantity" runat="server" ID="txtRecivedQuantity" Text=""></asp:TextBox>
                            </div>
                        </div>
