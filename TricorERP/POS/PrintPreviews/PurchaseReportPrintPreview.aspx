<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReportPrintPreview.aspx.cs" Inherits="TricorERP.POS.PrintPreviews.PurchaseReportPrintPreview" %>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Purchase Report Details</strong>&nbsp;<asp:Label ID="CurrentDatVariable" runat="server" Text="Label"></asp:Label></h3>
                </div>
                <hr />
                <br />
            </div>
