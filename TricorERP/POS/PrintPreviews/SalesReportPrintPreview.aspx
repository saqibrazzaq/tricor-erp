<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesReportPrintPreview.aspx.cs" Inherits="TricorERP.POS.PrintPreviews.SalesReportPrintPreview" %>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Sales Report Details</strong>&nbsp;<asp:Label ID="CurrentDatVariable" runat="server" Text="Label"></asp:Label></h3>
                </div>
                <hr />
                <br />
            </div>
