<%@ Page Title="" Language="C#" MasterPageFile="~/Tricor.Master" AutoEventWireup="true" CodeBehind="AddAddress.aspx.cs" Inherits="TricorERP.POS.BranchManager.AddAddress" %>
    ...
    <div class="row container-fluid">
        <div class="col-lg-4">
            <div class="input-group">
                <b>Name: </b> <asp:Label ID="cashierName" runat="server" Text=""></asp:Label>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="input-group">
