                        ...
                        <ItemTemplate>
                            <tr runat="server">
                                ...
                                <td>
                                    ...
                                    <%-- button that is used for onaly view the order --%>
                                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="hidden btn btn-default btn-xs" Text="View" CommandName="EditSaleOrder" CommandArgument='<%# Eval("ID") %>' />
